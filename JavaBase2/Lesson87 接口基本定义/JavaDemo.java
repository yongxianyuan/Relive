...
一些安全或者隐私的操作问题，在进行开发的过程中，如果要向外部隐藏全部实现的细节，则就可以通过接口来进行描述。
...
public class JavaDemo {
	...
	由于接口描述的一个公共定义标准，所有抽象方法访问权限都是public的,接口中关键字public可以省略 。
*/
...
public class JavaDemo {
	public static void main(String []args) {
		IMessage msg = new MessageImpl() ;
		Object obj = msg;   //接口也是一个Object实例对象
		// IChannel chl = (IChannel)msg;
		IChannel chl = (IChannel)obj;  //强制类型转换
